...
const Achievements = () => {
  return (
    <div className="bg-[#0f2327] bg-[url(/assets/achievements.avif)] bg-no-repeat bg-cover min-h-[87vh] flex justify-center items-center sub-font text-white sm:px-16 px-6 py-28">
